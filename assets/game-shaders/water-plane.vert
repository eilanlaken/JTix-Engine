...
void main()
{
    nearPoint = UnprojectPoint(a_position.x, a_position.y, 0.0, u_camera_view, u_camera_projection).xzy; // unprojecting on the near plane
    farPoint = UnprojectPoint(a_position.x, a_position.y, 1.0, u_camera_view, u_camera_projection).xzy; // unprojecting on the far plane
