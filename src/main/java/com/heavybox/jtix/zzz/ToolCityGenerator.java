...
public class ToolCityGenerator extends Tool {
    ...
    private static final MapTokenHouseCity.HouseType[] allTypes = MapTokenHouseCity.HouseType.values();
    private final TexturePack props;

    public float scale = 0.5f;
    //public float scale = 1;
    public MapTokenHouseCity.HouseType currentType = allTypes[0]; // TOWER_TALL, TOWER_SHORT, BUILDING_TALL_LEFT, ...
    ...
    public ToolCityGenerator(TexturePack props) {
        this.props = props;
        region = MapTokenHouseCity.HouseType.getRegion(props, currentType, baseIndex);
