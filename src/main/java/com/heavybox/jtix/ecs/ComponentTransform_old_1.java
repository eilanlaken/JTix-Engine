...
@Deprecated public class ComponentTransform_old_1 implements Component {
    ...
    /* can be null */
    public ComponentTransform_old_1 parent = null;
    ...
    public ComponentTransform_old_1() {
        this(0,0,0,0,0,0,1,1,1);
    }

    protected ComponentTransform_old_1(float x, float y, float z, float degX, float degY, float degZ, float sclX, float sclY, float sclZ) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.degX = degX;
