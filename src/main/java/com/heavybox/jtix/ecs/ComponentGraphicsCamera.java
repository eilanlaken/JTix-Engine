...
public class ComponentGraphicsCamera {
    ...
    public ComponentGraphicsCamera(float viewportWidth, float viewportHeight, float zoom) {
        this(viewportWidth, viewportHeight, zoom, 0.1f, 100, 70);
    }

    public ComponentGraphicsCamera update() {
        left.set(up).crs(direction);
        lens.update(position, direction, up);
        return this;
    }

    public ComponentGraphicsCamera update(float viewportWidth, float viewportHeight) {
