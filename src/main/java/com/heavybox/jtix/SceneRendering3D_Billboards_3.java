...
public class SceneRendering3D_Billboards_3 implements Scene {
    ...
    public SceneRendering3D_Billboards_3() {
    ...
    public void setup() {
        ...
        Assets.loadModel("assets/app-models/cloud-billboard_1.fbx", "assets/app-models/textures");
        Assets.finishLoading();

        modelSimplex = Assets.get("assets/models/simplex.fbx");
        modelCloud = Assets.get("assets/app-models/cloud-billboard_1.fbx");
...
//        System.out.println(transformCloud.getBasisZ(new Vector3()));
    ...
    private void orient_5(Matrix4x4 transform) {
//        Vector3 scale = transformCloud_1.getScale(new Vector3()); // TODO.
//
//        Vector3 basisZ = transformCloud_1.getBasisZ(new Vector3()).nor();
//        Vector3 cloudPosition = transformCloud_1.getPosition(new Vector3());
