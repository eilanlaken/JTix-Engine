...
public class SceneRendering2D_ECS_CTransform_1 extends ApplicationScreen {
    ...
    protected void refresh() {
        ...
        if (Keyboard.isKeyPressed(Keyboard.Key.F)) {
            ...
            t.rotateXDeg(5f, true);
            System.out.println("vals");
            System.out.println(t.angleXDeg);
            System.out.println(t.angleYDeg);
            System.out.println(t.angleZDeg);
        }
        ...
        renderer2D.drawTextureRegion(region_blue, t.x, t.y, t.angleXDeg, t.angleYDeg, t.angleZDeg, t.scaleX, t.scaleY);
