...
class Asset implements MemoryResource {
    ...
    Asset(final Object data, final AssetDescriptor descriptor, Array<Asset> dependencies) {
        this.refCount = 1;
        this.data = data;
    ...
    public void delete() {
        ...
        refCount--;
        if (refCount <= 0 && data instanceof MemoryResource) ((MemoryResource) data).delete();
    }
