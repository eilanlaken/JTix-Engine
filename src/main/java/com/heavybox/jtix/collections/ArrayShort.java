...
public class ArrayShort {
    ...
    public ArrayShort(int capacity) {
        this(true, capacity);
    }
    ...
    public ArrayShort(boolean ordered, int capacity) {
     ...
     * grown. */
    public ArrayShort(ArrayShort array) {
     ...
     * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
     *           memory copy. */
    public ArrayShort(boolean ordered, short[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    public void addAll (ArrayShort array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll (ArrayShort array, int offset, int length) {
    ...
    public boolean removeAll (ArrayShort array) {
        int size = this.size;
        int startSize = size;
        short[] items = this.items;
    ...
    public boolean equals (Object object) {
        ...
        if (!(object instanceof ArrayShort)) return false;
        ArrayShort array = (ArrayShort)object;
    ...
    static public ArrayShort with (short... array) {
        return new ArrayShort(array);
    }
