...
public final class CollectionsUtils {
    ...
    public static void sort(Object[] a) {
        arraySorterComparable.doSort(a,0, a.length);
    }
    ...
    public static <T> void sort(T[] a, Comparator<? super T> c) {
        arraySorter.doSort(a, c, 0, a.length);
    }

    public static <T> void sort(T[] a, Comparator<? super T> c, int fromIndex, int toIndex) {
    ...
    public static final class CollectionsSorterArray<T> {
        ...
        public void doSort(T[] a, Comparator<T> c, int lo, int hi) {
            ...
            // If array is small, do a "mini-ArraySorter
            //" with no merges
        ...
        /** Creates a ArraySorter
         * instance to maintain the state of an ongoing sort.
         *
         * @param a the array to be sorted
         * @param c the comparator to determine the order of the sort */
        private CollectionsSorterArray(T[] a, Comparator<? super T> c) {
            this.a = a;
            this.c = c;
        ...
        protected static <T> void sort(T[] a, int lo, int hi, Comparator<? super T> c) {
            ...
            /** March over the array once, left to right, finding natural runs, extending short natural runs to minRun elements, and
             * merging runs to maintain stack invariant. */
            CollectionsSorterArray<T> ts = new CollectionsSorterArray<T>(a, c);
            int minRun = minRunLength(nRemaining);
            do {
                // Identify next run
                int runLen = countRunAndMakeAscending(a, lo, hi, c);
    ...
    public static final class CollectionsSorterArrayComparable {
        ...
        protected CollectionsSorterArrayComparable() {
         ...
         *
         * @param a the array to be sorted */
        private CollectionsSorterArrayComparable(Object[] a) {
            this.a = a;
        ...
        static void sort(Object[] a, int lo, int hi) {
            ...
            /** March over the array once, left to right, finding natural runs, extending short natural runs to minRun elements, and
             * merging runs to maintain stack invariant. */
            CollectionsSorterArrayComparable ts = new CollectionsSorterArrayComparable(a);
            int minRun = minRunLength(nRemaining);
            do {
                // Identify next run
                int runLen = countRunAndMakeAscending(a, lo, hi);
