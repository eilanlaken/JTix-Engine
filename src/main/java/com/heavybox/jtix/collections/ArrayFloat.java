...
public class ArrayFloat implements MemoryPool.Reset {
    ...
    public ArrayFloat(int capacity) {
        this(true, capacity);
    }
    ...
    public ArrayFloat(boolean ordered, int capacity) {
     ...
     * grown. */
    public ArrayFloat(ArrayFloat array) {
     ...
     * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
     *           memory copy. */
    public ArrayFloat(boolean ordered, float[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    public void addAll (ArrayFloat array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll (ArrayFloat array, int offset, int length) {
    ...
    public float getCyclic(int index) {
    ...
    public boolean removeAll(ArrayFloat array) {
        int size = this.size;
        int startSize = size;
        float[] items = this.items;
    ...
    public boolean equals (Object object) {
        ...
        if (!(object instanceof ArrayFloat)) return false;
        ArrayFloat array = (ArrayFloat)object;
    ...
    static public ArrayFloat with(float... array) {
        return new ArrayFloat(array);
    }
