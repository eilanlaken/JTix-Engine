...
public class MapObjectObject<K, V> implements Iterable<MapObjectObject.Entry<K, V>> {
    ...
    public MapObjectObject(int initialCapacity) {
     ...
     * @param initialCapacity The backing array size is initialCapacity / loadFactor, increased to the next power of two. */
    public MapObjectObject(int initialCapacity, float loadFactor) {
    ...
    public MapObjectObject(MapObjectObject<? extends K, ? extends V> map) {
    ...
    public void putAll (MapObjectObject<? extends K, ? extends V> map) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MapObjectObject)) return false;
        MapObjectObject other = (MapObjectObject)obj;
    ...
    static private abstract class MapIterator<K, V, I> implements Iterable<I>, Iterator<I> {
        ...
        final MapObjectObject<K, V> map;
        int nextIndex, currentIndex;
        boolean valid = true;

        public MapIterator (MapObjectObject<K, V> map) {
            this.map = map;
            reset();
        }
    ...
    static public class Entries<K, V> extends MapIterator<K, V, Entry<K, V>> {
        ...
        public Entries (MapObjectObject<K, V> map) {
            super(map);
        }
        ...
        public Entry<K, V> next () {
            ...
            if (!valid) throw new CollectionsException("#iterator() cannot be used nested.");
            K[] keyTable = map.keyTable;
    ...
    static public class Values<V> extends MapIterator<Object, V, V> {
        public Values (MapObjectObject<?, V> map) {
            super((MapObjectObject<Object, V>)map);
        }
    ...
    static public class Keys<K> extends MapIterator<K, Object, K> {
        public Keys (MapObjectObject<K, ?> map) {
            super((MapObjectObject<K, Object>)map);
        }
