...
public class ScenePlanesGame_Volcano implements Scene {
    ...
    public Model volcanoModel;
    public Shader volcano_rocks_shader;
    public Shader volcano_lava_shader;


    public ScenePlanesGame_Volcano() {
    ...
    public void setup() {
        ...
        this.volcano_rocks_shader = new Shader(mountainVertexShaderSrc, mountainFragmentShaderSrc);
        ...
        volcanoModel = Assets.get("assets/game-models/map-1-mountain-volcano.fbx");
        System.out.println(volcanoModel.materials[1].name);
        volcanoModel.materials[0].materialAttributes.put("u_texture_grass", terrainStone);
        volcanoModel.materials[0].materialAttributes.put("u_texture_stone", terrainStone);
        volcanoModel.materials[0].materialAttributes.put("u_texture_snow", terrainSnow);
    }
    ...
    public void update() {
        ...
        for (int i = 0; i < volcanoModel.meshes.length; i++) {
            Renderer3D.drawModel_custom_shader_2(volcano_rocks_shader, volcanoModel.meshes[i], volcanoModel.materials[i], new Matrix4x4().translateGlobalAxisXYZ(512+255,0,0));
            //Renderer3D.drawModel_tmp_5(volcanoModel.meshes[i], volcanoModel.materials[i], new Matrix4x4().translateGlobalAxisXYZ(512+255,0,0));
        }
