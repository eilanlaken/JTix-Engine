...
public class SceneRendering3D_ModelsViewer_Scenes_6 implements Scene {

    private Camera camera;

    public Scene3D scene3D;

    public SceneRendering3D_ModelsViewer_Scenes_6() {
    ...
    public void update() {
        ...
        Scene3D.Node nodeHouse = scene3D.namedNodes.get("hotairballoon_4");
        ...
        for (int i = 0; i < modelHouse.meshes.length; i++) {
                Renderer3D.drawModel_tmp_5(modelHouse.meshes[i], modelHouse.materials[i], new Matrix4x4());
        }
