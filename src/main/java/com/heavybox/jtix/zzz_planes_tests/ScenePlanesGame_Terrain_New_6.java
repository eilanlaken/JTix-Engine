...
public class ScenePlanesGame_Terrain_New_6 implements Scene {
    ...
    public ScenePlanesGame_Terrain_New_6() {
    ...
    public void setup() {
        ...
        String terrainVertexShaderSrc = Assets.getFileContent("assets/game-shaders/terrain-3.vert");
        String terrainFragmentShaderSrc = Assets.getFileContent("assets/game-shaders/terrain-3.frag");
        ...
        terrainBlendMap = Assets.get("assets/game-maps/map-1-blendmap.jpg");
