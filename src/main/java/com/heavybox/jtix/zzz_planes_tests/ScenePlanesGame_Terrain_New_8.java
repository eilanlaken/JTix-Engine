...
public class ScenePlanesGame_Terrain_New_8 implements Scene {
    ...
    public Texture terrainHeightMap_1;
    public Texture terrainHeightMap_2;
    ...
    public ScenePlanesGame_Terrain_New_8() {
    ...
    public void setup() {
        ...
        Assets.loadTexture("assets/game-maps/hm-1.jpg", Texture.FilterMag.LINEAR, Texture.FilterMin.LINEAR, Texture.Wrap.CLAMP_TO_EDGE, Texture.Wrap.CLAMP_TO_EDGE, Graphics.getMaxAnisotropy());
        Assets.loadTexture("assets/game-maps/hm-2.jpg", Texture.FilterMag.LINEAR, Texture.FilterMin.LINEAR, Texture.Wrap.CLAMP_TO_EDGE, Texture.Wrap.CLAMP_TO_EDGE, Graphics.getMaxAnisotropy());
        ...
        terrain.materials[0].materialAttributes.put("u_texture_height_map", terrainHeightMap_1);
        terrain.materials[0].shader = terrainShader;
        terrain.materials[0].transparent = false;

        m = terrain.materials[0].clone();
        terrain.materials[0].materialAttributes.put("u_texture_height_map", terrainHeightMap_2);
