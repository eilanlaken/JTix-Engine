...
public class SceneRendering3D_ModelsViewer_Scenes_4 implements Scene {

    private Camera camera;

    public Scene3D scene3D;

    public SceneRendering3D_ModelsViewer_Scenes_4() {
    ...
    public void setup() {
        ...
        Assets.loadScene("assets/app-models/exports-all.fbx", "assets/app-models/textures");
        Assets.finishLoading();

        scene3D = Assets.get("assets/app-models/exports-all.fbx");
    ...
    public void update() {
        ...
        Scene3D.Node nodeHouse = scene3D.namedNodes.get("air-turbine_base");
        ...
        Scene3D.Node balloon = scene3D.namedNodes.get("air-turbine_blade");
