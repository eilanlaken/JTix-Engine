...
public class ScenePlanesGame_Terrain_New_10 implements Scene {
    ...
    public ScenePlanesGame_Terrain_New_10() {
    ...
    public void setup() {
        ...
        Assets.loadTexture("assets/game-maps/terrain-heightmap-2048.jpg", Texture.FilterMag.LINEAR, Texture.FilterMin.LINEAR, Texture.Wrap.CLAMP_TO_EDGE, Texture.Wrap.CLAMP_TO_EDGE, Graphics.getMaxAnisotropy());
        ...
        terrainHeightMap = Assets.get("assets/game-maps/terrain-heightmap-2048.jpg");
        ...
        terrain.materials[0].materialAttributes.put("u_tile_index_col", 4);
