...
public class ScenePlanesGame_Terrain_New_7 implements Scene {
    ...
    public ScenePlanesGame_Terrain_New_7() {
    ...
    public void setup() {
        ...
        Assets.loadTexture("assets/game-maps/heightmap-test-2.jpg", Texture.FilterMag.LINEAR, Texture.FilterMin.LINEAR, Texture.Wrap.REPEAT, Texture.Wrap.REPEAT, Graphics.getMaxAnisotropy());
        ...
        terrainHeightMap = Assets.get("assets/game-maps/heightmap-test-2.jpg");
