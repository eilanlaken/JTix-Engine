...
public enum VertexAttribute_old {
    ...
    VertexAttribute_old(final int glslVariableType, final String glslVariableName, final int length, int primitiveType, boolean normalized) {
    ...
    public static int getShaderAttributeBitmask(final String[] shaderAttributeNames) {
        ...
        for (final String shaderAttributeName : shaderAttributeNames) {
            for (VertexAttribute_old vertexAttribute : values()) {
