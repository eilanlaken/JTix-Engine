...
public class Renderer2D implements MemoryResourceHolder {
    ...
    public void drawText(final String text, final com.heavybox.jtix.z_deprecated.z_graphics_old.Font font, float x, float y, float angleZ, float scaleX, float scaleY) {
