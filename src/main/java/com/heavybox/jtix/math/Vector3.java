...
public class Vector3 implements MemoryPool.Reset {
...
//    }
     ...
     * @param matrix The matrix
     * @return This vector for chaining */
    public Vector3 mul (final Matrix4x4 matrix) {
        final float[] l_mat = matrix.val;
        return this.set(x * l_mat[Matrix4x4.M00] + y * l_mat[Matrix4x4.M01] + z * l_mat[Matrix4x4.M02] + l_mat[Matrix4x4.M03],
                x * l_mat[Matrix4x4.M10] + y * l_mat[Matrix4x4.M11] + z * l_mat[Matrix4x4.M12] + l_mat[Matrix4x4.M13],
                x * l_mat[Matrix4x4.M20] + y * l_mat[Matrix4x4.M21] + z * l_mat[Matrix4x4.M22] + l_mat[Matrix4x4.M23]);
    }

    /** Multiplies the vector by the transpose of the given matrix, assuming the fourth (w) component of the vector is 1.
     * @param matrix The matrix
     * @return This vector for chaining */
    public Vector3 traMul (final Matrix4x4 matrix) {
        final float[] l_mat = matrix.val;
        return this.set(x * l_mat[Matrix4x4.M00] + y * l_mat[Matrix4x4.M10] + z * l_mat[Matrix4x4.M20] + l_mat[Matrix4x4.M30],
                x * l_mat[Matrix4x4.M01] + y * l_mat[Matrix4x4.M11] + z * l_mat[Matrix4x4.M21] + l_mat[Matrix4x4.M31],
                x * l_mat[Matrix4x4.M02] + y * l_mat[Matrix4x4.M12] + z * l_mat[Matrix4x4.M22] + l_mat[Matrix4x4.M32]);
    }
...
//    }
     ...
     * @param matrix The matrix.
     * @return This vector for chaining */
    public Vector3 prj (final Matrix4x4 matrix) {
        final float[] l_mat = matrix.val;
        final float l_w = 1f / (x * l_mat[Matrix4x4.M30] + y * l_mat[Matrix4x4.M31] + z * l_mat[Matrix4x4.M32] + l_mat[Matrix4x4.M33]);
        return this.set((x * l_mat[Matrix4x4.M00] + y * l_mat[Matrix4x4.M01] + z * l_mat[Matrix4x4.M02] + l_mat[Matrix4x4.M03]) * l_w,
                (x * l_mat[Matrix4x4.M10] + y * l_mat[Matrix4x4.M11] + z * l_mat[Matrix4x4.M12] + l_mat[Matrix4x4.M13]) * l_w,
                (x * l_mat[Matrix4x4.M20] + y * l_mat[Matrix4x4.M21] + z * l_mat[Matrix4x4.M22] + l_mat[Matrix4x4.M23]) * l_w);
    }
     ...
     * @param matrix The matrix
     * @return This vector for chaining */
    public Vector3 rot (final Matrix4x4 matrix) {
        final float[] l_mat = matrix.val;
     ...
     * rotation, does not work for scaling. For those, use {@link #rot(Matrix4x4)} with {@link Matrix4x4#inv()}.
     * @param matrix The transformation matrix
     * @return The vector for chaining */
    public Vector3 unrotate (final Matrix4x4 matrix) {
        final float[] l_mat = matrix.val;
        return this.set(x * l_mat[Matrix4x4.M00] + y * l_mat[Matrix4x4.M10] + z * l_mat[Matrix4x4.M20],
                x * l_mat[Matrix4x4.M01] + y * l_mat[Matrix4x4.M11] + z * l_mat[Matrix4x4.M21],
                x * l_mat[Matrix4x4.M02] + y * l_mat[Matrix4x4.M12] + z * l_mat[Matrix4x4.M22]);
    }
     ...
     * scaling. For those, use {@link #mul(Matrix4x4)} with {@link Matrix4x4#inv()}.
     * @param matrix The transformation matrix
     * @return The vector for chaining */
    public Vector3 untransform (final Matrix4x4 matrix) {
        final float[] l_mat = matrix.val;
        x -= l_mat[Matrix4x4.M03];
        y -= l_mat[Matrix4x4.M03];
        z -= l_mat[Matrix4x4.M03];
        return this.set(x * l_mat[Matrix4x4.M00] + y * l_mat[Matrix4x4.M10] + z * l_mat[Matrix4x4.M20],
                x * l_mat[Matrix4x4.M01] + y * l_mat[Matrix4x4.M11] + z * l_mat[Matrix4x4.M21],
                x * l_mat[Matrix4x4.M02] + y * l_mat[Matrix4x4.M12] + z * l_mat[Matrix4x4.M22]);
    }
    ...
    public boolean isPerpendicular (Vector3 vector, float epsilon) {
        return Math.abs(this.dot(vector)) < epsilon;
    }
