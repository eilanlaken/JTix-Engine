...
public class Vector4 implements MemoryPool.Reset {

    public static final Vector4 X_UNIT = new Vector4(1, 0, 0, 0);
    public static final Vector4 Y_UNIT = new Vector4(0, 1, 0, 0);
    public static final Vector4 Z_UNIT = new Vector4(0, 0, 1, 0);
    public static final Vector4 W_UNIT = new Vector4(0, 0, 0, 1);
     ...
     * @param w The w-component
     * @return This vector for chaining */
    public Vector4 set(final Vector3 vector, float z, float w) {
