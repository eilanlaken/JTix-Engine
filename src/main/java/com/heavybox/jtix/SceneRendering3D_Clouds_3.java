...
public class SceneRendering3D_Clouds_3 implements Scene {
    ...
    public SceneRendering3D_Clouds_3() {
    ...
    public void start() {
        ...
        transformSimplex.translateGlobalAxisXYZ(0,-10,0);

        //transformCloud_1.scale(10,1,5);
        ...
        transformCloud_2.translateGlobalAxisXYZ(MathUtils.randomUniformFloat(-0.6f,0.6f), MathUtils.randomUniformFloat(-1,1),MathUtils.randomUniformFloat(-0.6f,0.6f));
        transformCloud_3.translateGlobalAxisXYZ(MathUtils.randomUniformFloat(-0.6f,0.6f), MathUtils.randomUniformFloat(-1,1),MathUtils.randomUniformFloat(-0.6f,0.6f));
        transformCloud_4.translateGlobalAxisXYZ(MathUtils.randomUniformFloat(-0.6f,0.6f), MathUtils.randomUniformFloat(-1,1),MathUtils.randomUniformFloat(-0.6f,0.6f));
        transformCloud_5.translateGlobalAxisXYZ(MathUtils.randomUniformFloat(-0.6f,0.6f), MathUtils.randomUniformFloat(-1,1),MathUtils.randomUniformFloat(-0.6f,0.6f));
    }
