...
public class SceneRendering3D_Terrain_2 implements Scene {
    ...
    public SceneRendering3D_Terrain_2() {
    ...
    public void setup() {
        ...
        String vertexShaderSrc = Assets.getFileContent("assets/app-shaders/terrain-blend-map-shader-2.vert");
        String fragmentShaderSrc = Assets.getFileContent("assets/app-shaders/terrain-blend-map-shader-2.frag");
