...
public class Color {
    ...
    private static final MapObjectObject<String, Color> catalog = new MapObjectObject<>();

    static {
        catalog.clear();
        catalog.put("CLEAR", Color.CLEAR);
        catalog.put("CLEAR_WHITE", Color.CLEAR_WHITE);
        catalog.put("BLACK", Color.BLACK);

        catalog.put("WHITE", Color.WHITE);
        catalog.put("LIGHT_GRAY", Color.LIGHT_GRAY);
        catalog.put("GRAY", Color.GRAY);
        catalog.put("DARK_GRAY", Color.DARK_GRAY);

        catalog.put("BLUE", Color.BLUE);
        catalog.put("NAVY", Color.NAVY);
        catalog.put("ROYAL", Color.ROYAL);
        catalog.put("SLATE", Color.SLATE);
        catalog.put("SKY", Color.SKY);
        catalog.put("CYAN", Color.CYAN);
        catalog.put("TEAL", Color.TEAL);

        catalog.put("GREEN", Color.GREEN);
        catalog.put("CHARTREUSE", Color.CHARTREUSE);
        catalog.put("LIME", Color.LIME);
        catalog.put("FOREST", Color.FOREST);
        catalog.put("OLIVE", Color.OLIVE);

        catalog.put("YELLOW", Color.YELLOW);
        catalog.put("GOLD", Color.GOLD);
        catalog.put("GOLDENROD", Color.GOLDENROD);
        catalog.put("ORANGE", Color.ORANGE);

        catalog.put("BROWN", Color.BROWN);
        catalog.put("TAN", Color.TAN);
        catalog.put("FIREBRICK", Color.FIREBRICK);

        catalog.put("RED", Color.RED);
        catalog.put("SCARLET", Color.SCARLET);
        catalog.put("CORAL", Color.CORAL);
        catalog.put("SALMON", Color.SALMON);
        catalog.put("PINK", Color.PINK);
        catalog.put("MAGENTA", Color.MAGENTA);

        catalog.put("PURPLE", Color.PURPLE);
        catalog.put("VIOLET", Color.VIOLET);
        catalog.put("MAROON", Color.MAROON);
    }
     ...
     *         . */
    public static Color putInCatalog (String name, Color color) {
        return catalog.put(name, color);
    }
